...
//        'From decimal: 21000 is 101011000011000'
    ...
    public static String skrzat(String type, String input) {
        if (type.equals("b") && input.equals("0")) {
            return "From binary: " + input + " is 0";
        }
        if (type.equals("d") && input.equals("0")) {
            return "From decimal: " + input + " is 0";
        }
        if (type.equals("d")) {
        ...
        for (int i = 0; i <= input.length() - 1; i++) {
            result += Integer.parseInt("" + input.charAt(i)) * Math.pow(-2, --pow);
        }
        return "From binary: " + input + " is " + result;
    }
    ...
    public static String fromBinary(String input) {
        ...
        return "From decimal: " + input +  " is " +  res;
    }
